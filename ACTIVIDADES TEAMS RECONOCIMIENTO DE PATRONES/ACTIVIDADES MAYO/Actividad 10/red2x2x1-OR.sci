...
//MODIFICACIONES HECHAS POR ALUMNO: CARLOS ALEJANDRO ACOSTA MENDEZ
//RECONOCIMIENTO DE PATRONES 2025
...
Y = [0 1 1 1];               // Salidas esperadas (ESTAS SALIDAS SON LAS CLAVES)
